...
def execute_user_code(code, func_name):
    """
...
if __name__ == "__main__":
    ...
    code_utilisateur = """def collection():
    livres = {
        "Le Petit Prince": "Fiction",
        "Python pour les Nuls": "Informatique",
        "L'Étranger": "Littérature"
    ...
    for jeu in resultat["jeux_de_donnees"]:
        ...
        result = execute_user_code(code_utilisateur, "collection")
