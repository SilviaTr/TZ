...
if __name__ == "__main__":
    ...
    dataset1 = {"name": "Jeu de test caché 1", "data": "Pouw cette potion, il vous faudwa du sang de licowne et un cheveu de centauwe."\
            ,"lettre_a_remplacer": "w", "lettre_de_remplacement": "r","impact": 2}
    dataset2 = {"name": "Jeu de test caché 2","data": "Ne vw pws dwns la foret interdite. C’est un endroit dwngereux."
                , "lettre_a_remplacer": "w", "lettre_de_remplacement": "a", "impact": 2}
    ...
    condition3 = False
    if 'range(len(texte)-1)' not in code_utilisateur:
        condition3 = True
    ...
    def reparo(texte,lettre_a_remplacer, lettre_de_remplacement):
