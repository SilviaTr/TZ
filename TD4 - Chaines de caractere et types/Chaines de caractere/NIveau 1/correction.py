...
if __name__ == "__main__":
    ...
    jeu_de_donnee_visible = {"name": "Jeu de données visible", "caractere" : "y", "data": "Les sorcières et les sorciers regardaient avec étonnement l'imposant château de Poudlard, ignorant les dangers qui les attendaient à l'intérieur.",
"impact": 3}
    ...
    dataset1 = {"name": "Jeu de test caché 1", "caractere" : "z", "data": "xxyywwzz", "impact": 1}
    dataset2 = {"name": "Jeu de test caché 2", "caractere" : "o", "data": "Vyyificatizz du code des élèves, wwdicatizz pxxr les dictizznaires", "impact": 1}
    ...
    # On n'a pas le droit à la fonction index
    ...
    if "index" in code_utilisateur:
        contrainte = False
        contraintesMessages.append("Vous avez utilisé la fonction index.")
        contraintesHard.append("Vous avez utilisé la fonction index.")
        append_log("Contrainte non respectée: fonction index utilisée")
    ...
    try:
        ...
        for dataset_index, dataset in enumerate(jeu_de_donnees):
            ...
            correction = reparo(dataset["caractere"], dataset["data"])
