...
if __name__ == "__main__":
    ...
    jeu_de_donnee_visible = {"name": "Jeu de données visible", "data":   "riovas ruel reugél ed te sétucésrep sreicros xua egufer nu rirffo'd tnattemrep eigam ed elocé enu rednof ed tnerèdicéd ) \
...
"impact": 3}
    ...
    dataset1 = {"name": "Jeu de test caché 1", "data": "seennod ed uej ud tseT", "impact": 1}
    dataset2 = {"name": "Jeu de test caché 2", "data": " engil al à ruoter, \
        ceva seennod ed uej ud tseT", "impact": 1}
    ...
    if "reversed" in code_utilisateur:
        contrainte = False
        contraintesMessages.append("Vous avez utilisé la fonction reversed.")
        contraintesHard.append("Vous avez utilisé la fonction reversed.")
        append_log("Contrainte non respectée: fonction reversed utilisée")
