...
if __name__ == "__main__":
    ...
    jeu_de_donnee_visible = {"name": "Jeu de données visible", "data": "vw gu wp itcpf uqtekgt", "alphabet": "abcdefghijklmnopqrstuvwxyz","impact": 3}
    ...
    dataset1 = {"name": "Jeu de test caché 1", "data": "Ng pqrn xgpkp fg Mwnug Egtcu, swh n'vwgpmuukpv rquq gpvqjtkp fguv oqukpgcvk ugtnb yq ugu iétqfkpv. Kn fgecnqwv uqwpkp ngt ngvvgpu fg vqtkq rqtg" , "alphabet": "abcdefghijklmnopqrstuvwxyz", "impact": 1}
    dataset2 = {"name": "Jeu de test caché 1", "data": "Nc oéjvfg fg Egtcu gvu uktog vg gggkugtcq rgf kpvkpg" , "alphabet": "abcdefghijklmnopqrstuvwxyz", "impact": 1}
