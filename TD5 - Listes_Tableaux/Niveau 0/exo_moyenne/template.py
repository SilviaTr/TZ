    ...
    resultat = {
        ...
        "jeux_de_donnees": [
            ...
            },
            {
                ...
                "data":  [11, 13, 15, 9, 12, 5, 12, 11, 7, 13, 18, 11, 3, 14],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
        ...
        "contraintes": [
            {
                "name": "Pas de sum",
                "validation": False,
                "message": "Vous avez utilisé la fonction sum. L'exercice n'est pas validé",
                "impact": 20
            },
            {
                "name": "Pas de mean",
                "validation": False,
                "message": "Vous avez utilisé la fonction mean. Vous perdez 15 points",
                "impact": 15
            }
        ],
        "bonus": [],
...
"""
    ...
    for contrainte in resultat['contraintes']:
        if contrainte['name'] == "Pas de sum":
            if "sum" in code_utilisateur:
                contrainte['validation'] = False
            else:
                contrainte['validation'] = True

        if contrainte['name'] == "Pas de mean":
            if "mean" in code_utilisateur:
                contrainte['validation'] = False
            else:
                contrainte['validation'] = True
