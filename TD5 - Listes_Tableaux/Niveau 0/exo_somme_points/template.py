...
if __name__ == "__main__":
    ...
    resultat = {
        ...
        "jeux_de_donnees": [
            {
                "name": "Poufsouffle",
                "data": [5, 5, -1, -5, -1, 5, 5, -5, 10, -1, -1, 10, -5, 10],
                "hidden": False,
                "validation": False,
            ...
            {
                "name": "Serpentard",
                "data": [-1, -1, -1, -1, -20, -5, 10, 5, -1, 20, 5, 5, -1, -1, -1, 10],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
            ...
            {
                "name": "Serdaigle",
                "data":  [5, 10, -1, -5, 10, 15, -5, -1, -1, 20, 10, -5, -5, -5, 10],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
            ...
            {
                "name": "Gryffondor",
                "data":  [-1, -1, 5, -5, 5, 5, -5, -5, 100, -50, -50, -50, 50, 50, 60, 10],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
