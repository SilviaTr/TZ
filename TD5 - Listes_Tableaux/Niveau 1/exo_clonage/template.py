...
def execute_user_code(code, input_data):
    ...
    """
    local_namespace = {"inventaire": input_data}
    restricted_globals = {}
...
if __name__ == "__main__":
    ...
    resultat = {
        ...
        "jeux_de_donnees": [
            {
                "name": "Liste 1",
                "data":  ["sangsue", "plume", "poil de chat", "chenille", "rate de rat", "peau de serpent", "sang d'ogre"],
                "hidden": False,
                "validation": False,
            ...
            {
                "name": "Liste 2 (caché)",
                "data": ["crapaud", "chauve-souris", "rat", "chenille", "rate de rat", "peau de serpent", "sang d'ogre"],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
