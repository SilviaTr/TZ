...
if __name__ == "__main__":
    ...
    resultat = {
        ...
        "jeux_de_donnees": [
            {
                "name": "Pièce 1",
                "data": ["armoire", "chapeau", "grimoire", "baguette", "lit", "valise"],
                "hidden": False,
                "validation": False,
            ...
            {
                "name": "Pièce 2",
                "data": ["baguettes", "bureau", "plume", "plante", "etagere"],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
            ...
            {
                "name": "Pièce 3",
                "data":  ["chaudron", "potion", "boule de cristal", "fiole", "bois", "cage", "tabouret"],
                "hidden": True,
                "validation": False,
                "resultat_utilisateur": "",
                "correction": "",
        ...
        "contraintes": [
            {
                "name": "Pas de in",
                "validation": False,
                "message": "Vous avez utilisé in. L'exercice n'est pas validé",
                "impact": 20
            },
            {
                "name": "Pas de break",
                "validation": False,
                "message": "Vous avez utilisé break. L'exercice n'est pas validé",
                "impact": 20
            }
        ],
        "bonus": [
            {
                "name": "Utilisation de any",
                "validation": False,
                "message": "Vous avez utilisé la fonction any(). La code est optimisé, vous remportez 5 points bonus !",
                "impact": 5
            }
        ],
        "console": {
    ...
    def input_function(input):
        indice_piece = 0
        baguette = False
        while indice_piece < len(input) and not baguette:
            if input[indice_piece] == "baguette":
                baguette = True
            indice_piece += 1
        return baguette
...
"""
    ...
    for bonus in resultat['bonus']:
        ...
        if bonus['name'] == "Utilisation de any":
             if "any" in code_utilisateur:
