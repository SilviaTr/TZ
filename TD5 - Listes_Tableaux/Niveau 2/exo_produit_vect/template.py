...
if __name__ == "__main__":
    ...
    resultat = {
        ...
        "contraintes": [
         ...
         "bonus": [{
            "name": "Pas de for",
            "validation": False,
            "message": "Vous avez réussi l'exercice sans utilisé de for, +3 points !",
            "impact": 3
        }],
        "console": {
            "type": None,
    ...
    for jeu in resultat['jeux_de_donnees']:
        jeu['correction'] = input_function((jeu['v1'], jeu['v2']))
...
"""
    ...
    for bonus in resultat['bonus']:
        ...
        if bonus['name'] == "Pas de for":
            if code_utilisateur.count("for") == 0:
    ...
    for jeu in resultat["jeux_de_donnees"]:
        ...
        result = execute_user_code(code_utilisateur, jeu["v1"], jeu["v2"])
