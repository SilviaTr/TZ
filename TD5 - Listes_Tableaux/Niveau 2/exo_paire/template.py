...
if __name__ == "__main__":
    ...
    resultat = {
        ...
        "jeux_de_donnees": [
            {
                "name": "Echiquier",
                "data": [2, 62, 13, 98, 80, 85, 77, 64, 83, 27, 45, 21, 28, 8, 82, 26, 87, 69, 85, 20, 41, 16, 11, 55, 43, 68, 96, 94, 52, 68],
                "hidden": False,
                "validation": False,
        ...
        "contraintes": [
            {
                "name": "Pas de remove",
                "validation": False,
                "message": "Vous avez utilisé la bibliothèque remove. L'exercice n'est pas validé",
                "impact": 20
            }
        ],
        "console": {
